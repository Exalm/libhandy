                  ...
                  GtkWidget *widget)
{
  ...
  case GTK_PAN_DIRECTION_DOWN:
    return (double) gtk_widget_get_allocated_height (widget) /
                    gtk_widget_get_allocated_height (self->overlay);

  case GTK_PAN_DIRECTION_LEFT:
  case GTK_PAN_DIRECTION_RIGHT:
    return (double) gtk_widget_get_allocated_width (widget) /
                    gtk_widget_get_allocated_width (self->overlay);
