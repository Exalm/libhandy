...
static void
dialog_complex_deeper_clicked_cb (HdyLeaflet *leaflet)
{
  hdy_leaflet_set_visible_child_name (leaflet, "sub");
}

static void
dialog_complex_back_clicked_cb (HdyLeaflet *leaflet)
{
  hdy_leaflet_set_visible_child_name (leaflet, "main");
}
                           ...
                           HdyDemoWindow *self)
{
  ...
  GtkWidget *dlg, *back, *deeper, *leaflet;
  ...
  leaflet = GTK_WIDGET (gtk_builder_get_object (builder, "content_leaflet"));
  g_signal_connect_swapped (deeper, "clicked", G_CALLBACK (dialog_complex_deeper_clicked_cb), leaflet);
  g_signal_connect_swapped (back, "clicked", G_CALLBACK (dialog_complex_back_clicked_cb), leaflet);
